...
The official image comes without an interface, only the base system with drivers, a fish terminal, archivers, repositories, and file and network systems. However, you can use fan builds from the Telegram forum, provided you've verified their safety.
